...
<div class="w-full p-6 bg-gray-100 min-h-screen">
    <div class="w-full  bg-white rounded-lg shadow-md overflow-hidden">
        ...
        <form method="POST" action="{{ route('galerytestimonivideo.store') }}" enctype="multipart/form-data" class="p-6">
            @csrf
            ...
            <div class="mb-4">
                ...
                <input type="file" name="file_video" id="file_video" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-300" value="{{ old('file_video') }}" required>
