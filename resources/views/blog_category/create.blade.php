    ...
    <div class="w-full p-6 bg-gray-100 min-h-screen">
        <div class="w-full  bg-white rounded-lg shadow-md overflow-hidden">
            <div class="bg-teal-300 p-4">
                <h2 class="text-xl font-bold text-teal-800">Buat Kategori Blog</h2>
            </div>

            <form method="POST" action="{{ route('blogcategory.store') }}" enctype="multipart/form-data" class="p-6">
                @csrf
                ...
                <div class="flex items-center justify-between">
                    <button type="submit"
                        class="px-6 py-2 bg-teal-300 hover:bg-teal-400 text-teal-800 font-medium rounded-lg">Kirim Ke
                        Halaman
                        Home</button>
