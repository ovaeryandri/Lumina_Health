        ...
        <section class="flex w-full mt-16">
            ...
            <div class="flex flex-col ml-14">
                <div class=" w-96 h-max flex flex-wrap text-justify">
                    Lumina Health siap mendampingi Anda dengan layanan konsultasi kesehatan terpercaya. Tim profesional
                    kami berkomitmen memberikan solusi terbaik untuk setiap kebutuhan medis Anda.
                </div>
                ...
                <div class="rounded-md space-y-2 mt-5 text-teal-600">
                    <div class="flex items-start gap-x-2">
                        ...
                        <p>Konsultasi kesehatan dengan dokter profesional dan berpengalaman.</p>
                    </div>
                    <div class="flex items-start gap-x-2">
                        <svg class="w-4 h-4 mt-1" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd"
                        ...
                        <p>Program Kesehatan terbaik untuk Anda.</p>
                    </div>
                    <div class="flex items-start gap-x-2">
                        <svg class="w-4 h-4 mt-1" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd"
                        ...
                        <p>Layanan cepat, ramah, dan terpercaya.</p>
                    </div>
                    <div class="flex items-start gap-x-2">
                        <svg class="w-4 h-4 mt-1" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd"
                        ...
                        <p>Tersedia layanan darurat 24 jam.</p>
                    </div>
                </div>
            </div>

            <div class="w-80 h-max ml-5 p-9 rounded-4xl bg-teal-500 flex flex-col items-center text-center">
