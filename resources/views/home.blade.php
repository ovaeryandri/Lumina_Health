    ...
    <main data-aos="fade-up" data-aos-offset="200" data-aos-delay="50" data-aos-duration="700"
        ...
        <section class="flex w-full mt-16">
            ...
            <div class="flex flex-col ml-14">
                <div class=" w-96 h-max flex flex-wrap text-justify">
                    Lumina Health berkomitmen memberikan perawatan terbaik untuk kesehatan dan kesejahteraan Anda.
                    Layanan kami dirancang untuk memenuhi kebutuhan unik setiap individu dengan pendekatan yang holistik
                    dan personal.
                </div>
                ...
                <div class="rounded-md space-y-2 mt-5 text-teal-600">
                    <div class="flex items-start gap-x-2">
                        ...
                        <p>Layanan kesehatan yang fleksibel dan mudah diakses.</p>
                    </div>
                    <div class="flex items-start gap-x-2">
                        <svg class="w-4 h-4 mt-1" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd"
                        ...
                        <p>Pendekatan holistik untuk tubuh dan pikiran yang sehat.</p>
                    </div>
                    <div class="flex items-start gap-x-2">
                        <svg class="w-4 h-4 mt-1" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd"
                        ...
                        <p>Komitmen penuh terhadap kenyamanan dan kepuasan pelanggan.</p>
                    </div>
                </div>
            </div>

            <div class="w-80 h-max p-9 rounded-4xl bg-teal-500 flex flex-col items-center text-center">
            ...
            <img src="/images/consultation-1.jpg" alt="Konsultasi"
                class="absolute -z-50 right-28 rounded-2xl w-3xl h-96 mt-72">
                    ...
                    <x-card nomor="{{ $loop->iteration }}">
                        ...
                        <x-slot:detail>
                            @if (Auth::guard('akun_user')->check() && Auth::guard('akun_user')->user()->programs->contains($programs->id))
                                <div class="text-green-500 font-semibold">Selamat! Anda telah bergabung di program ini
                                </div>
                            @else
